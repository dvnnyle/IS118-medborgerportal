...
# --- Sluttresultat basert på kombinasjonen ---
if sak in [("A", "A", "A")]:
    utfall = (
        "Konfliktene ble håndtert åpent og strukturert, noe som skapte bedre forståelse og trygghet "
    ...
    utfall = (
        "Individuelle samtaler bidro til å redusere konfliktnivået mellom Silje og Sivert. "
    ...
    utfall = (
        "Noen utfordringer ble håndtert, mens andre forble uavklarte. Dette gir en ujevn teamdynamikk, "
    ...
    utfall = (
        "Selv om det ble gjennomført et avklaringsmøte, førte valgene dine til økt arbeidsbelastning og redusert motivasjon. "
    ...
    utfall = (
        "Ved å avvente begge konfliktene og samtidig prioritere leveranser over relasjoner, "\
    ...
    utfall = (
        "Prosjektet viser blandede tendenser. Teamet kommer videre, men det er fortsatt flere "
        "utfordringer knyttet til kommunikasjon, rolleavklaring og forventningsstyring. "
        "Videre ledelse bør fokusere på relasjoner og felles forståelse for å sikre fremdrift."
    )
